...
void  main(void)
{
	...
	#ifdef TEST	
	SYN_FrameInfo(2, "[v10][m5][t4]欢迎使用全球鹰电子语音交互系统！");
...
void 	User_handle(uint8 dat)
{
     //UARTSendByte(dat);//串口识别码（十六进制）
		 if(0==dat)
		 {
		  G0_flag=ENABLE;
			LED=0;
			SYN_FrameInfo(0, "[v10][m5][t4] 你好主人");
		 }
			 ...
			 switch(dat)		   /*对结果执行相关操作,客户可删除Printcom 串口输出语句替换为其他需要控制的代码*/
			  {
				  case CODE_DMCS:			
            P10=1;						
					  SYN_FrameInfo(0, "[v10][m5][t4]中国");
						break;
					case CODE_KFBYZ:	
						P11=1;
						SYN_FrameInfo(0, "[v10][m5][t4]哈尔滨");
						 break;
					case CODE_KD:			
            P12=1;						
						SYN_FrameInfo(0, "[v10][m5][t4]全球鹰电子");
						break;					
					case CODE_BJ:			
						P13=1;
					  SYN_FrameInfo(0, "[v10][m5][t4]好的，已经开灯");
						break;
					case CODE_SH:											
						P13=0;
						SYN_FrameInfo(0, "[v10][m5][t4]好的，已经关灯");
						break;
					case CODE_GD:					
						break;
					case CODE_GZ:					
